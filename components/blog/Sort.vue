...
<template>
  ...
  >
    <!--  -->
    <div
      class="w-fit md:min-w-48 h-10 flex items-center justify-between gap-2 border border-third rounded-lg bg-third px-4 hover:scale-105 hover:opacity-90 transition-all duration-300"
